...
// =========================================================================
// 1. STATIC DATA (Moving Outside Component to Fix Scope & Render Errors)
// =========================================================================
const heroSlides = [
  {
    id: 1,
...
function Home() {
  ...
  // Effect 1: Project Carousel Auto-scroll
  useEffect(() => {
  ...
  // Effect 2: Hero Carousel Autoplay
  useEffect(() => {
  ...
  // Effect 3: Counter Animation for Stats Section
  useEffect(() => {
